...
@section('title', 'Server Error - NontonKu')

@section('content')
<div class="min-h-[60vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full text-center space-y-8">
        <div>
            <h1 class="text-9xl font-extrabold text-gray-400 dark:text-zinc-600 tracking-tighter">500</h1>
            <h2 class="mt-4 text-3xl font-bold text-gray-900 dark:text-white">Internal Server Error</h2>
            <p class="mt-2 text-lg text-gray-600 dark:text-zinc-400">
                Oops, something went wrong on our servers. We are looking into it.
            </p>
        </div>
