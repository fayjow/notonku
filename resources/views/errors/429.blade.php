...
@section('title', 'Too Many Requests - NontonKu')

@section('content')
<div class="min-h-[60vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full text-center space-y-8">
        <div>
            <h1 class="text-9xl font-extrabold text-yellow-500 tracking-tighter">429</h1>
            <h2 class="mt-4 text-3xl font-bold text-gray-900 dark:text-white">Too Many Requests</h2>
